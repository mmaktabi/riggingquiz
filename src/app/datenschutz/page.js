  ...
  return (
    <main >
      <div className=" pt-20 pb-20 mx-auto px-5 md:px-20 py-10">
        ...
        <p>Sabine Hößel<br />Schweinfurter Str. 28<br />97076 Würzburg<br />Germany</p>
        <p>Telefon: 0931 45 28 67 10</p>
        <p>E-Mail:&nbsp;<a href="mailto:info@apex-riggingschule.de">info@apex-riggingschule.de</a></p>
        ...
        <p><b>Cookie-Einwilligung mit Borlabs Cookie&nbsp;</b></p>
        ...
        <p>Wenn Sie unsere Website betreten, wird ein Borlabs-Cookie in Ihrem Browser gespeichert, in dem die von Ihnen erteilten Einwilligungen oder der Widerruf dieser Einwilligungen gespeichert werden. Diese Daten werden nicht an den Anbieter von Borlabs Cookie weitergegeben. Die erfassten Daten werden gespeichert, bis Sie uns zur Löschung auffordern bzw. das Borlabs-Cookie selbst löschen oder der Zweck für die Datenspeicherung entfällt.&nbsp;</p>
        <p>Zwingende gesetzliche Aufbewahrungsfristen bleiben unberührt. Details zur Datenverarbeitung von Borlabs Cookie finden Sie unter https://de.borlabs.io/kb/welche-daten-speichert-borlabs-cookie/ Der Einsatz der Borlabs-Cookie-Consent-Technologie erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen für den Einsatz von Cookies einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. c DSGVO.</p>
